...
void InitScene()
{
    ...
    // cyan
    Sphere[0].center = vec3( -2.0, 2.0 + sin(5.0* iTime), 0.0 + cos(5.0 * iTime));
    Sphere[0].radius = 0.66;
    Sphere[0].materialID = 1;

    // blue
    Sphere[1].center = vec3( 3.0 + cos(iTime*4.0), 1.5, 2.0 );
    Sphere[1].radius = 1.0;
    Sphere[1].materialID = 2;

    // changing color
    Sphere[2].center = vec3(0.5, 1.0, 5.0);
    Sphere[2].radius = 1.0;
    Sphere[2].materialID = 
        (mod(iTime, 3.0) < 0.5)? 3 : 
            (mod(iTime, 3.0) < 1.0)? 2 : 
    ...
    Material[1].k_d = vec3( 0.341, 0.905, 1.0 );
    Material[1].k_a = 0.2 * Material[1].k_d;
    Material[1].k_r = 2.0 * Material[1].k_d;
    Material[1].k_rg = 0.5 * Material[1].k_r;
    Material[1].n = 64.0;

    Material[2].k_d = vec3( 0.341, 0.384, 1.0 );
    Material[2].k_a = 0.2 * Material[2].k_d;
    Material[2].k_r = vec3( 1.0, 1.0, 1.0 );
    Material[2].k_rg = 0.5 * Material[2].k_r;
    Material[2].n = 128.0;

    Material[3].k_d = vec3( 1.0, 0.882, 0.341 );
    ...
    // Light 0.
    Light[0].position = vec3( 2.0, -0.5 + abs(sin(1.0 * iTime)), -2.0);
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec3 cam_pos = vec3( 1.5 * cos(iTime), 0.8, 1.5 * sin(iTime) );
